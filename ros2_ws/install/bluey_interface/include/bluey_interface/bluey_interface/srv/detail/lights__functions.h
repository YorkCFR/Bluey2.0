...
#ifndef BLUEY_INTERFACE__SRV__DETAIL__LIGHTS__FUNCTIONS_H_
#define BLUEY_INTERFACE__SRV__DETAIL__LIGHTS__FUNCTIONS_H_
...
/// Create srv/Lights message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bluey_interface__srv__Lights_Request__init().
...
/// Destroy srv/Lights message.
/**
 * It calls
 * bluey_interface__srv__Lights_Request__fini()
...
/// Check for srv/Lights message equality.
/**
...
/// Initialize array of srv/Lights messages.
/**
...
/// Finalize array of srv/Lights messages.
/**
 * It calls
 * bluey_interface__srv__Lights_Request__fini()
...
/// Create array of srv/Lights messages.
/**
 * It allocates the memory for the array and calls
 * bluey_interface__srv__Lights_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Lights messages.
/**
 * It calls
 * bluey_interface__srv__Lights_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Lights message array equality.
/**
...
/// Copy an array of srv/Lights messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bluey_interface__srv__Lights_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It calls
 * bluey_interface__srv__Lights_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It allocates the memory for the array and calls
 * bluey_interface__srv__Lights_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It calls
 * bluey_interface__srv__Lights_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BLUEY_INTERFACE__SRV__DETAIL__LIGHTS__FUNCTIONS_H_
