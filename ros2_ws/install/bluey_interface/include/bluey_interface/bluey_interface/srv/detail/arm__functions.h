...
#ifndef BLUEY_INTERFACE__SRV__DETAIL__ARM__FUNCTIONS_H_
#define BLUEY_INTERFACE__SRV__DETAIL__ARM__FUNCTIONS_H_
 ...
 * calls
 * bluey_interface__srv__Arm_Request__init().
...
/**
 * It calls
 * bluey_interface__srv__Arm_Request__fini()
 ...
 * bluey_interface__srv__Arm_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * bluey_interface__srv__Arm_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * bluey_interface__srv__Arm_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It calls
 * bluey_interface__srv__Arm_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It allocates the memory for the array and calls
 * bluey_interface__srv__Arm_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_bluey_interface
...
/**
 * It calls
 * bluey_interface__srv__Arm_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BLUEY_INTERFACE__SRV__DETAIL__ARM__FUNCTIONS_H_
