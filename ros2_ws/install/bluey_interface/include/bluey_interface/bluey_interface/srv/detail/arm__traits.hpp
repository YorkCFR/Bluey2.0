...
inline void to_yaml(
  const bluey_interface::srv::Arm_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const bluey_interface::srv::Arm_Request & msg)
{
...
[[deprecated("use bluey_interface::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const bluey_interface::srv::Arm_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  bluey_interface::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use bluey_interface::srv::to_yaml() instead")]]
inline std::string to_yaml(const bluey_interface::srv::Arm_Response & msg)
{
  return bluey_interface::srv::to_yaml(msg);
}
