...
#include "bluey_interface/srv/detail/arm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const bluey_interface::srv::Arm_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bluey_interface::srv::Arm_Request & ros_message)
{
  // Member: arm
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const bluey_interface::srv::Arm_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bluey_interface::srv::Arm_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Arm_Request(full_bounded, 0);
}
...
{
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bluey_interface, srv, Arm_Request)() {
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_bluey_interface
cdr_serialize(
  const bluey_interface::srv::Arm_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bluey_interface::srv::Arm_Response & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const bluey_interface::srv::Arm_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<bluey_interface::srv::Arm_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Arm_Response(full_bounded, 0);
}
...
{
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bluey_interface, srv, Arm_Response)() {
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm_Response__handle;
}
...
{
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bluey_interface, srv, Arm)() {
  return &bluey_interface::srv::typesupport_fastrtps_cpp::_Arm__handle;
}
