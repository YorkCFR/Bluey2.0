...
static const _Arm_Request_type_support_symbol_names_t _Arm_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Arm_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Arm_Request)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Arm_Request_message_type_support_handle;
}
...
static const _Arm_Response_type_support_symbol_names_t _Arm_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Arm_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_bluey_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Arm_Response)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Arm_Response_message_type_support_handle;
}
...
static const _Arm_type_support_symbol_names_t _Arm_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Arm)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Arm)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Arm_service_type_support_handle;
}
