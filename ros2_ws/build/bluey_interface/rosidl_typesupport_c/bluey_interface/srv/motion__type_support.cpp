...
static const _Motion_Request_type_support_symbol_names_t _Motion_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Motion_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Motion_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Motion_Request)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Motion_Request_message_type_support_handle;
}
...
static const _Motion_Response_type_support_symbol_names_t _Motion_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Motion_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Motion_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_bluey_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Motion_Response)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Motion_Response_message_type_support_handle;
}
...
static const _Motion_type_support_symbol_names_t _Motion_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Motion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bluey_interface, srv, Motion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, bluey_interface, srv, Motion)() {
  return &::bluey_interface::srv::rosidl_typesupport_c::Motion_service_type_support_handle;
}
