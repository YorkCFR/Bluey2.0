...
class Metaclass_Arm(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bluey_interface.srv import _arm
...
class Arm(metaclass=Metaclass_Arm):
    from bluey_interface.srv._arm import Arm_Request as Request
    from bluey_interface.srv._arm import Arm_Response as Response
