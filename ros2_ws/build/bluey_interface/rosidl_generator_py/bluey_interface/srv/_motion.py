...
class Metaclass_Motion(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from bluey_interface.srv import _motion
...
class Motion(metaclass=Metaclass_Motion):
    from bluey_interface.srv._motion import Motion_Request as Request
    from bluey_interface.srv._motion import Motion_Response as Response
