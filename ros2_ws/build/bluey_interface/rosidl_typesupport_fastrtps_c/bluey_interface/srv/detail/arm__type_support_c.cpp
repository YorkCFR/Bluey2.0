...
#include "bluey_interface/srv/detail/arm__rosidl_typesupport_fastrtps_c.h"
...
using _Arm_Request__ros_msg_type = bluey_interface__srv__Arm_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _Arm_Request__ros_msg_type * ros_message = static_cast<_Arm_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: arm
  {
    uint8_t tmp;
    cdr >> tmp;
...
size_t get_serialized_size_bluey_interface__srv__Arm_Request(
  const void * untyped_ros_message,
...
static uint32_t _Arm_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_bluey_interface__srv__Arm_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bluey_interface
size_t max_serialized_size_bluey_interface__srv__Arm_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Arm_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_bluey_interface__srv__Arm_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm_Request)() {
...
using _Arm_Response__ros_msg_type = bluey_interface__srv__Arm_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _Arm_Response__ros_msg_type * ros_message = static_cast<_Arm_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bluey_interface
size_t get_serialized_size_bluey_interface__srv__Arm_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Arm_Response__ros_msg_type * ros_message = static_cast<const _Arm_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_bluey_interface__srv__Arm_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_bluey_interface
size_t max_serialized_size_bluey_interface__srv__Arm_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _Arm_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_bluey_interface__srv__Arm_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm_Response)() {
...
// already included above
// #include "bluey_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "bluey_interface/srv/arm.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bluey_interface, srv, Arm)() {
  return &Arm__handle;
}
